  ...
  <div class="row justify-content-center">
    <div class="col-sm-5">
      <div class="row">
        ...
        <div class="col-4">
          <?= Html::a('Agregar' . $animateIcon, ['/customer/assign', 'id' => (string) $model->id], [
            'class' => 'btn add-label btn-assign',
    ...
    <div class="col-sm-5">
      <div class="row">
        ...
        <div class="col-4">
          <?= Html::a(Yii::t('rbac-admin', 'Remove') . $animateIcon, ['/customer/revoke', 'id' => (string) $model->id], [
            'class' => 'btn btn-danger btn-assign revoke-label',
