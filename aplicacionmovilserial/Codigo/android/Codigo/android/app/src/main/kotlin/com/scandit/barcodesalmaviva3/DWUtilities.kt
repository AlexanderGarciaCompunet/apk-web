package com.scandit.barcodesalmaviva3;
...
object DWUtilities {
    ...
    private const val SELECTED_SCANNER= "INTERNAL_CAMERA" //"INTERNAL_CAMERA" // INTERNAL_IMAGER INTERNAL_CAMERA BLUETOOTH_ZEBRA ---PLUGABLE_SSI_RS5000 BLUETOOTH_RS6000  BLUETOOTH_RS5100
    ...
    fun createProfile(context: Context) {
        ...
        barcodeProps.putString("scanner_selection_by_identifier", SELECTED_SCANNER)//INTERNAL_CAMERA
    ...
    fun setConfig(context: Context, numberOfBarcodesPerScan: Int, bReportInstantly: Boolean, timer : Int, Beam_Width:Int, Aim_Type: Int)  {
       ...
       barcodeConfig.putString("RESET_CONFIG", "true")
        val barcodeProps = Bundle()
        //  Note: configure_all_scanners does not work here, I guess because not all DW scanners (Camera?) support multi barcode
        barcodeProps.putString("scanner_selection_by_identifier", SELECTED_SCANNER) //Si el escaner no esta disponnible  se resetean todos los valores
