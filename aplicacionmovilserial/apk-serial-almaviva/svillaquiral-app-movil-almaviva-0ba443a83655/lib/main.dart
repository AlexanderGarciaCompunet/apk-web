...
class _AppRootState extends State<AppRoot> {
  ...
  void _logOutUser() {
    const SnackBar snackBar = SnackBar(content: Text("Sesión Cerrada, vuelve a ingresar"));
    ...
    return MultiProvider(
      ...
      child: GestureDetector(
        ...
        child: MaterialApp(
          ...
          title: 'Pública Calidad',
          theme: ThemeData(fontFamily: 'MuseoSans'),
          scaffoldMessengerKey: snackbarKey,
          initialRoute: BCRoutes.Login_screen.routeName,
          routes: {
            ...
            BCRoutes.Material_screen.routeName: (context) => const MaterialScreen(),
            BCRoutes.LectureMode_screen.routeName: (context) => const LectureModeScreen(),
            BCRoutes.LecturePallet_screen.routeName: (context) => const LecturePalletScreen(),
            BCRoutes.BoxCountScreen.routeName: (context) => const BoxCountScreen(),
            BCRoutes.Help.routeName: (context) => const HelpScreen(),
            BCRoutes.UnitsCountScreen.routeName: (context) => const UnitsCountScreen(),
            BCRoutes.LectureBoxScreen.routeName: (context) => const LectureBoxScreen(),
            BCRoutes.SplitViewUnitMatrixMaterial.routeName: (context) =>
                UnicMatrixScanScreen(DataCaptureContext.forLicenseKey(licenseKey)),
            BCRoutes.ListBarcodeScreen.routeName: (context) => const ListBarcodeScreen(),
            BCRoutes.DatawedgeScanScreen.routeName: (context) => const DatawedgeScanScreen(),
            BCRoutes.ListBarcodeDWScreen.routeName: ((context) => const ListBarcodeDWScreen()),
